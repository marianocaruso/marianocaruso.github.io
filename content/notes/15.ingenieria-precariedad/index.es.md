---
title: "Ingeniería de la precariedad"
...
La persistencia en el uso de lo que el sistema económico etiqueta como inutil o dicho de otro modo que la probabilidad de utilidad es nula, no es solo economía de trinchera; es un marco epistemológico. Al injertar $B$ en $A$, no solo estamos cerrando un circuito o reparando una máquina, estamos reescribiendo nuestra relación de dependencia con la técnica. Transformamos la carencia en un operador de diseño que desafía la obsolescencia programada con la única herramienta verdaderamente inagotable. Es una forma de combatir el aumento de entropía programado por la industria mediante la inyección de ingenio local, e.g. casero, con la profunda terquedad la vida que se resiste a darse por muerta.