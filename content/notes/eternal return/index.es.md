...
$$
U(t)\;=\;\exp\Bigl(-\frac{i}{\hbar}Ht\Bigr)\;=\;\exp\Bigl(-\frac{i\omega t}{\hbar}\,\hat w\cdot\sigma\Bigr)\,.
$$
Como $(\hat w\cdot\sigma)^2=I$, luego $U(t)=\cos\Bigl(\frac{\omega t}{\hbar}\Bigr)I - i\,(\hat w\cdot\sigma)\,\sin\Bigl(\frac{\omega t}{\hbar}\Bigr).$
